...
const EasterEggTriggerCore = {
  ...
  */
  addListener(egg) {
    const newEgg = egg;
    console.log('%c%s', 'color: green', '------------------------------- addListener', newEgg.type);
    newEgg.input = [];
    document.addEventListener(newEgg.type, e => {
      $this.capturePattern(e, newEgg);
    }, false);
  },
  /*
  	---------------------------------------- Capture Pattern
  ...
  */
  ...
  reset(egg) {
    const thisEgg = egg;
    console.log('%c%s', 'background-color: black; color: orange; padding: 5px;', '------------------------------- reset', egg);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "40e5cb1cd1bb8b815d43"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.2cb5ae2b0b54a2e274e6.hot-update.js.map