...
const EasterEggTriggerCore = {
  ...
  */
  capturePattern(e) {
    ...
    // ! Inputs is being pushed a dblclick as ['click', 'click', 'dblclick'] //
    $this.input.push(key);
    // $this.checkPattern(e);
  ...
  */
  checkPattern(e) {
    // console.log({ e });
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      // ! Imputs is counting a dblclick as ['click', 'click', 'dblclick'] //
      console.log({
        egg
      }, this.input);

      // Check Keyboard Events //
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEqual)(egg === null || egg === void 0 ? void 0 : egg.pattern, this.input)) {
        // Check Targets if Mouse Events //
        if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.includes)(EasterEggTrigger.mouseEvents, e.type)) {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "4770bc3909e476b44bdc"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.1a98aed38b839a8c1319.hot-update.js.map