  ...
  */
  ...
  emitEvent(egg) {
    ...
    if (Object.keys(easterEggsTriggerEggs).length === 1) {
      ...
      console.log('----');
      console.log('----');
      console.log(egg.type, this.capturePattern, true);
      document.removeEventListener(egg.type, this.capturePattern, true);
    } else {
      this.rebuild(egg);
    }
    if (egg.callback) {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "907f70ae979e05591109"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.82851708a6f03533e097.hot-update.js.map