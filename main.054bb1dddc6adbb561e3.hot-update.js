  ...
  */
  ...
  emitEvent(egg) {
    ...
    if (Object.keys(easterEggsTriggerEggs).length === 1) {
      document.removeEventListener(egg.type, this.capturePattern);
      console.log('+++++++++');
    } else {
      this.rebuild(egg);
    }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "ef40b4eeb0c92c05e369"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.054bb1dddc6adbb561e3.hot-update.js.map