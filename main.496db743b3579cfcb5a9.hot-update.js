...
const EasterEggTriggerCore = {
  ...
  */
  init(globalOptions, methodOptions) {
    console.group('%c%s', 'color: #f00', 'EasterEggTriggerCore ------------------------------- Core Init');
    console.log({
      globalOptions,
      methodOptions
    });
    ...
    $this = this;
    console.log('%c%s', 'color: #f00', 'this.pluginOptions', this.pluginOptions);
    this.layEggs();
  },
  /*
  	---------------------------------------- Lay Eggs
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "5730a5d29158cb103c14"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.496db743b3579cfcb5a9.hot-update.js.map