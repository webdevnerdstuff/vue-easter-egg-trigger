  ...
  checkPattern(e) {
    ...
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      ...
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEqual)(egg.pattern, this.input)) {
        ...
        $this.hatched('hatched keyboard event');
        this.emitEvent(egg);
      }
      return false;
    });
  ...
  */
  ...
  emitEvent(egg) {
    if (Object.keys(easterEggsTriggerEggs).length === 1) {
      ...
      document.removeEventListener(type, this.capturePattern, false);
    } else {
      this.rebuild(egg);
    }
    if (egg.callback) {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "bcebd07d532f10bd74a6"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.c07570e4073ad502b184.hot-update.js.map