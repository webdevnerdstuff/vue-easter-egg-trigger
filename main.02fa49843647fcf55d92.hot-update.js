...
const EasterEggTriggerCore = {
  ...
  */
  addListener(egg) {
    console.log('%c%s', 'color: green', '------------------------------- addListener', egg.type);
    document.addEventListener(egg.type, e => {
      $this.capturePattern(e, egg);
    }, false);
  },
  /*
  	---------------------------------------- Capture Pattern
  ...
  */
  checkPattern(e) {
    ...
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      ...
      console.log('%c%s', 'color: #f0f', 'this.input', egg.input);
      console.log('%c%s', 'color: #f0f', 'isEqual(egg.pattern, this.input)', (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEqual)(egg.pattern, egg.input));
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEqual)(egg.pattern, egg.input)) {
  ...
  */
  ...
  reset(egg) {
    ...
    console.log('%c%s', 'background-color: black; color: orange; padding: 5px;', '------------------------------- reset', this.pluginOptions);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "97f45d3483ebc7737ae6"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.02fa49843647fcf55d92.hot-update.js.map