...
const EasterEggTriggerCore = {
  ...
  */
  layEggs() {
    ...
    // console.log('%c%s', 'color: orange', '------------------------------- layEggs', { easterEggsTriggerEggs });
  ...
  */
  ...
  collectEggs() {
    ...
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      // console.log('%c%s', 'color: yellow', egg.name, { egg });
      const newEgg = egg;
      if (!newEgg.pattern) {
  ...
  */
  capturePattern(e) {
    // console.log('%c%s', 'color: blue', '------------------------------- capturePattern', { e });
    // console.log({ $this });
    let key = '';
    // console.log({ e });
    ...
    // -------------------- Mouse Events //
    console.log('$this.mouseEvents', mouseEvents);
  ...
  */
  checkPattern(e) {
    ...
    // console.log('%c%s', 'color: #f0f', 'easterEggsTriggerEggs, e', { easterEggsTriggerEggs, e });
    // console.log('\n');
    ...
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      // console.log('%c%s', 'color: #f0f', 'egg, this.input', { egg }, this.input);

      // Check Keyboard Events //
      // console.log('%c%s', 'color: #f0f', 'egg.pattern', egg.pattern);
      // console.log('%c%s', 'color: #f0f', 'this.input', this.input);
      // console.log('%c%s', 'color: #f0f', 'isEqual(egg.pattern, this.input)', isEqual(egg.pattern, this.input));
  ...
  */
  checkMouseTarget(e, egg) {
    console.log('%c%s', 'background-color: black; color: red; padding: 10px; font-size: 40px', 'checkTarget', {
      egg
    });
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "23e2825a7a66bb64084c"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.bef5ac6d0fd60199cac0.hot-update.js.map