...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    const $this = this;
    this.logStyle = ['background-color: black', `border-image: ${rainbowLinearGradient} 1`, 'border-style: solid', 'border-width: 4px', 'color: #fff', 'font-weight: normal', 'padding: 8px'];
    this.$easterEgg({
      name: 'id-target',
      pattern: ['click'],
      type: 'click',
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "431c229ac8a94bc6833f"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.27b889a58149c12f8ea2.hot-update.js.map