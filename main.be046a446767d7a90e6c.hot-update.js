...
const EasterEggTriggerCore = {
  ...
  */
  // Emit Bus Event and/or Callback //
  emitEvent(egg) {
    console.log('%c%s', 'background-color: black; color: #0f0', '------------------------------- emitEvent', {
      egg
    });
    console.log('%c%s', 'background-color: black; color: #0f0', 'Object.keys(easterEggsTriggerEggs).length', Object.keys(easterEggsTriggerEggs).length);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "17db188c710d25ffd98d"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.be046a446767d7a90e6c.hot-update.js.map