...
const EasterEggTriggerCore = {
  ...
  */
  init(globalOptions, methodOptions) {
    console.group('%c%s', 'color: #0f0', 'EasterEggTriggerCore ------------------------------- Core Init');
    console.log({
      globalOptions,
      methodOptions
    });
    ...
    $this = this;
    console.log('%c%s', 'color: #0f0', 'this.pluginOptions', this.pluginOptions);
    this.layEggs();
  },
  /*
  	---------------------------------------- Lay Eggs
  ...
  */
  layEggs() {
    ...
    console.log('%c%s', 'color: #ff0', '------------------------------- layEggs', {
  ...
  */
  ...
  collectEggs() {
    console.log('%c%s', 'color: orange', '------------------------------- collectEggs', easterEggsTriggerEggs.length);
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      console.log('%c%s', 'color: orange', egg.name, {
        egg
      });
      const newEgg = egg;
      if (!newEgg.pattern) {
  ...
  */
  addListener() {
    console.log('%c%s', 'color: #f0f', '------------------------------- addListener', this.pluginOptions.type);
  ...
  */
  ...
  emitEvent(egg) {
    ...
    console.log('Object.keys(easterEggsTriggerEggs).length', Object.keys(easterEggsTriggerEggs).length);
  ...
  */
  hatched() {
    ...
    console.log('%c%s', 'color: #0f0; background: #000; padding: 5px; font-size: 20px;', 'HATCHED 🥚');
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "496db743b3579cfcb5a9"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.be9910dccf31877b7a1d.hot-update.js.map