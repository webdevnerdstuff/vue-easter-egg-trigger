  ...
  */
  ...
  emitEvent(egg) {
    ...
    if (Object.keys(easterEggsTriggerEggs).length === 1) {
      ...
      document.removeEventListener(this.pluginOptions.type, this.capturePattern, true);
    } else {
      this.rebuild(egg);
    }
    if (egg.callback) {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "a44255d701b73ced7057"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.a3b6f570e1b6c64b23f1.hot-update.js.map