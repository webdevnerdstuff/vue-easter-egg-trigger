...
This packages makes it nice and easy to add Easter Egg triggers to your Vue 2 site. Looking for the Vue 3 version? You can find it [here](https://github.com/webdevnerdstuff/vue3-easter-egg-trigger).
