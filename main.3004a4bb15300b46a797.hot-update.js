...
const EasterEggTriggerCore = {
  ...
  */
  ...
  collectEggs() {
    console.log('%c%s', 'color: #f0f', '------------------------------- collectEggs', easterEggsTriggerEggs.length);
    Object.values(easterEggsTriggerEggs).forEach(egg => {
      console.log('%c%s', 'color: #f0f', egg.name, {
        egg
      });
      const newEgg = egg;
      if (!newEgg.pattern) {
  ...
  */
  addListener() {
    console.log('%c%s', 'color: orange', '------------------------------- addListener', this.pluginOptions.type);
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "be9910dccf31877b7a1d"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.3004a4bb15300b46a797.hot-update.js.map