...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted() {
    const $this = this;
    this.logStyle = ['background-color: black', `border-image: ${this.rainbowLinearGradient} 1`, 'border-style: solid', 'border-width: 4px', 'color: #fff', 'font-weight: normal', 'padding: 8px'];
    this.$easterEgg({
      name: 'id-target',
      pattern: ['click'],
      type: 'click',
  ...
  methods: {
    ...
    logResults(el) {
      console.log('%c%s', this.rainbowLinearGradient, `triggered: ${el}`);
    },
    triggered(el) {
      console.log('=================', {
        el
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "75b9d62bff49c23e6eb7"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.428671fddb390db8c1b2.hot-update.js.map