...
const EasterEggTriggerCore = {
  ...
  */
  checkPattern(e) {
    console.log('%c%s', 'color: purple', '------------------------------- checkPattern', this);
    console.log('%c%s', 'color: purple', {
      easterEggsTriggerEggs,
      e
    });
    console.log('\n');
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "bea3eac3128ca34c294d"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=main.259c9e6451e1d1c24994.hot-update.js.map